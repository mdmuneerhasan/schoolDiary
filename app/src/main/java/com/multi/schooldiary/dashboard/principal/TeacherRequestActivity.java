...
import com.multi.schooldiary.activity.*;
            ...
            public void onBindViewHolder(final SetDefaultAdapter.Holder holder, final SetDefaultClass setDefaultClass) {
                ...
                holder.btn1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        connection.getDbSchool().child(savedData.getValue("schoolId")).child("schoolRequest")
                                .child(setDefaultClass.getStClass()).child(setDefaultClass.getUid()).removeValue();
                        connection.getDbSchool().child(savedData.getValue("schoolId")).child("staff").child(setDefaultClass.getStClass())
                                .child(setDefaultClass.getUid()).setValue(setDefaultClass);
                        connection.getDbUser().child(setDefaultClass.getUid())
                ...
                holder.btn2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        connection.getDbSchool().child(savedData.getValue("schoolId")).child("staff")
                                .child(setDefaultClass.getStClass()).child(setDefaultClass.getUid()).removeValue();
                        connection.getDbSchool().child(savedData.getValue("schoolId")).child("schoolRequest")
