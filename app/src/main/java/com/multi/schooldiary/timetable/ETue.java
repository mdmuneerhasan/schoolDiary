...
public class ETue extends Fragment {
    ...
    public void onStart() {
        ...
        connection.getDbSchool().child(savedData.getValue("schoolId")).child("timetable")
                ...
                .child("tue").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                connection.getDbSchool().child(savedData.getValue("schoolId")).child("timetable")
                        .child(savedData.getValue("stClass"))
                        .child("tue").removeEventListener(this);
            }
