...
public class EFri extends Fragment {
    ...
    public void onStart() {
        ...
        connection.getDbSchool().child(savedData.getValue("schoolId")).child("timetable")
                ...
                .child("fri").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                connection.getDbSchool().child(savedData.getValue("schoolId")).child("timetable")
                        .child(savedData.getValue("stClass"))
                        .child("fri").removeEventListener(this);
            }
