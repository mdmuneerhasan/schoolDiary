...
public class ESun extends Fragment {
    ...
    public void onStart() {
        ...
        connection.getDbSchool().child(savedData.getValue("schoolId")).child("timetable")
                ...
                .child("sun").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                connection.getDbSchool().child(savedData.getValue("schoolId")).child("timetable")
                        .child(savedData.getValue("stClass"))
                        .child("sun").removeEventListener(this);
            }
