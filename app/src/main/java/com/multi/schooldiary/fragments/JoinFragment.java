...
import com.multi.schooldiary.dashboard.principal.CollegeFragmentActivity;
import com.multi.schooldiary.dashboard.principal.SchoolFragmentActivity;
import com.multi.schooldiary.dashboard.student_or_guardian.StudentJoinFragmentActivity;
import com.multi.schooldiary.dashboard.teacher.TeacherFragmentActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnSchool :
                ...
                break;
            default: new SavedData(getContext()).toast("this feature is disabled fro this version");
        }
    }
}